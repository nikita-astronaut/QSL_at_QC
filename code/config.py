...
class opt_parameters:
    def __init__(self):
        ...
        self.path_to_logs = '/home/astronaut/Documents/QSL_at_QC/logs/test_20spins_OBCPBC_initpi2/{:.3f}/'.format(j2)
        ...
        self.eigenvalues = []#1, 1, 1]#, 1, 1]#1, -1, 1]#, 1]
        self.sectors = []#0, 0, 0]#, 0, 0]#[0, 2, 0]#, 0]  # in Toms notation
        self.degrees = []#2, 4, 2]#, 4, 2]#[4, 4, 2]#, 2]
